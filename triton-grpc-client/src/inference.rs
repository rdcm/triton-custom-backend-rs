...
pub struct ModelMetrics {
    ...
    /// @@
    #[prost(message, repeated, tag = "1")]
    pub metric_control: ::prost::alloc::vec::Vec<model_metrics::MetricControl>,
}
/// Nested message and enum types in `ModelMetrics`.
pub mod model_metrics {
    ...
    pub struct MetricControl {
        ...
        /// @@
        #[prost(message, optional, tag = "1")]
        pub metric_identifier: ::core::option::Option<metric_control::MetricIdentifier>,
        /// @@  .. cpp:var:: oneof metric_options
        /// @@
        /// @@     The value to override the metrics defined in metric_identifier.
        /// @@
        #[prost(oneof = "metric_control::MetricOptions", tags = "2")]
        pub metric_options: ::core::option::Option<metric_control::MetricOptions>,
    }
    /// Nested message and enum types in `MetricControl`.
    pub mod metric_control {
        /// @@
...
pub struct ModelConfig {
    ...
    pub model_metrics: ::core::option::Option<ModelMetrics>,
